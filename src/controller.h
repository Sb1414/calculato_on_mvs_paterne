...
class Controller {
 ...
 public:
  ...
  std::vector<double> CrCalculations(double sum_credit, double time_credit,
                                double per, bool check);
  std::vector<double> DepCalculations(bool check, double deposit_term, double deposit_amount, double interest_rate,
